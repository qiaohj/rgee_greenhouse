...
for (gh in unique(greenhouse_differ$code)){
  ...
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio2_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  ...
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio5_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P6. Min Temperature of Coldest Period 
  bio6 <- min(tmin, na.rm=T)
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio6_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P7. Temperature Annual Range (P5-P6) 
  bio7<-bio5-bio6
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio7_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P3. Isothermality (P2 / P7) 
  bio3<-100*bio2/bio7
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio3_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P12. Annual Precipitation 
  
  # P13. Precipitation of Wettest Period 
  bio13<-max(prec, na.rm=T)
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio13_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P14. Precipitation of Driest Period 
  bio14<-min(prec, na.rm=T)
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio14_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  # P15. Precipitation Seasonality( Coefficient of Variation) 
  bio12<-sum(prec, na.rm=T)
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio12_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  ...
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio4_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
  ...
  writeRaster(bio1, sprintf("../Data/bioclim_%s/bio15_qh_%d.tif", "quhua_greenhouse", gh), overwrite=T)
}
